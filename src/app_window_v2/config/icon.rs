...
///
/// Construct with [`WindowIconV2::from_rgba`] (raw pixels in memory) or
/// [`WindowIconV2::from_rgba_file`] (raw pixels read from disk).
///
...
/// and feed the buffer to [`WindowIconV2::from_rgba`].
#[derive(Debug, Clone)]
pub struct WindowIconV2 {
