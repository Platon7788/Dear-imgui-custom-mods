//! Force-directed knowledge-graph viewer for Dear ImGui.
//!
//! An Obsidian-style graph widget with Barnes-Hut physics, pan/zoom/select,
//! a built-in sidebar (search, tag filter, time-travel), metrics
//! (PageRank / Louvain / betweenness — Phase C), and SVG/DOT/Mermaid export
//! (Phase D).
//!
//! # Quick Start
//!
...
impl GraphViewer {
    ...
    pub fn render(&mut self, ui: &Ui, graph: &mut GraphData) -> Vec<GraphEvent> {
        ...
        // Sidebar (Phase B/C will populate with controls).
