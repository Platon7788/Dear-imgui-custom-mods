...
//! hand an immutable reference to [`crate::knowledge_graph::GraphViewer`] for
...
/// [`crate::knowledge_graph::GraphViewer`] for rendering and physics.
///
/// # Thread safety
///
...
impl GraphData {
    ...
    /// ID is invalid.
    ///
    /// Marks `dirty_metrics` so analytics are recomputed on the next render.
...
mod tests {
    use super::*;
    use crate::knowledge_graph::style::EdgeStyle;
